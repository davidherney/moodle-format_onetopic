...
$string['icontext_help'] = 'Add font awesome, glyphicon ou otra clase del icono. I';

$string['icontext'] = 'Full icon class text';
$string['icontext_help'] = 'Add font awesome, glyphicon, or anyother icon class. Introduzca el nombre completo de la clase distintiva ex. "fa fa-user" para fontawesome iconos.';
