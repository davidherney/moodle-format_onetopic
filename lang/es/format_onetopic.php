...
$string['appearancedeleted'] = 'Apariencia eliminada correctamente.';
$string['appearances'] = 'Apariencias personalizadas';
$string['appearancescope_site'] = 'Para todo el sitio';
$string['appearanceusages'] = 'Usos de "{$a}"';
$string['appearanceusagesbutton'] = 'Mostrar usos';
...
$string['availablefor'] = 'Disponible para';
$string['availableforerror'] = 'Debe seleccionar al menos una opción.';
...
$string['checkingavailability'] = 'Verificando disponibilidad...';
...
$string['createnewappearance'] = 'Crear nueva apariencia';
$string['createnewappearance_section'] = 'Nueva apariencia de sección';
$string['createnewappearance_subsection'] = 'Nueva apariencia de subsección';
...
$string['deleteappearance'] = 'Eliminar apariencia';
$string['deleteappearanceconfirm'] = '¿Está seguro de que desea eliminar la apariencia "{$a}"? Todas las referencias a esta apariencia serán eliminadas.';
$string['editappearance'] = 'Editar apariencia';
...
$string['nousagesfound'] = 'Esta apariencia no se está usando actualmente en ningún lugar.';
$string['onetopic:editallappearances'] = 'Editar todas las apariencias';
$string['onetopic:editappearances'] = 'Editar apariencias del curso';
...
$string['sectionstyles'] = 'Estilos de contenido';
$string['sectionstyles_help'] = 'Establecer los estilos de contenido para la sección, como la disposición de recursos.';
$string['sectionstylesetdefault'] = 'Establecer estilos de contenido';
$string['sectionstylestitle'] = 'Estilos de contenido';
$string['settingsheaderstyles'] = 'Estilos predeterminados de las pestañas';
$string['showfromothers'] = 'Mostrar tema';
$string['subsection'] = 'Subsección';
...
$string['tabstylesetcontent'] = 'Contenido';
...
$string['timesused'] = 'Veces usada';
$string['togglemenu'] = 'Mostrar menú de pestañas';
$string['topicslabel'] = 'Temas';
$string['type'] = 'Tipo';
$string['uniquecode'] = 'Código único';
$string['uniquecode_help'] = 'Un identificador único para esta apariencia. Solo se permiten letras, números, guiones (-) y guiones bajos (_).';
$string['uniquecodeavailable'] = 'Este código único está disponible.';
$string['uniquecodeexists'] = 'Este código único ya está en uso por otra apariencia.';
$string['uniquecodeinvalid'] = 'El código único solo puede contener letras, números, guiones (-) y guiones bajos (_).';
...
$string['sampleresource'] = 'Recurso de ejemplo';
$string['sampleactivity'] = 'Actividad de ejemplo';
$string['samplesubsection'] = 'Subsección';
$string['sampleforum'] = 'Foro de discusión';
$string['samplepage'] = 'Página de contenido';
...
$string['resourcelayout_buttons'] = 'Botones';
$string['resourcelayout_cards'] = 'Tarjetas';
$string['resourcelayout_timeline'] = 'Línea de tiempo';
