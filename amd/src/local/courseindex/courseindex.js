 ...
 *
 * @module     format_onetopic/local/courseindex/courseindex
 * @class      format_onetopic/local/courseindex/courseindex
...
import Exporter from "format_onetopic/local/courseeditor/exporter";
...
export default class Component extends BaseComponent {
    ...
    async _createSection({state, element}) {
        ...
        // Create the new content.
        const newcomponent = await this.renderComponent(fakeelement, 'format_onetopic/local/courseindex/section', data);
        // Replace the fake node with the real content.
        const newelement = newcomponent.getElement();
